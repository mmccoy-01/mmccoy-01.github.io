...
!function(){for(var e=document.links,t=0,r=e.length;t<r;t++){var n,o=e[t];o.hostname&&o.hostname!==window.location.hostname&&(n=o.getAttribute("rel")||"",o.target="_blank",/(^|\s)noopener(\s|$)/.test(n)||(n+=" noopener"),/(^|\s)noreferrer(\s|$)/.test(n)||(n+=" noreferrer"),o.setAttribute("rel",n.trim()))}}();
