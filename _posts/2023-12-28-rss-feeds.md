...
<style>
  /* Add your global Greco-Roman beige/tan/marble theme styles here */
  body {
    background-color: #eae8e4; /* Beige background color */
    font-family: 'Georgia', serif; /* Serif font for a classical look */
  }
  ...
  a.button-download {
    ...
    border-radius: 5px;
    font-size: 16px;
    border: 1px solid #8b4513; /* SaddleBrown border color */
    cursor: pointer;
  }

  a.button-download:hover {
    background-color: #8b4513; /* Darker tan on hover */
  }
</style>

<a href="/src/files/rss-feed.opml" download="rss-feed.opml" class="button-download">
