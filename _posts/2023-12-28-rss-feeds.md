...
<head>
  ...
  <style>
    ...
    .corinthian-button {
      ...
      background-color: #f5deb3; /* Tan button color */
      border: 1px solid #d2b48c; /* Darker tan border color */
      padding: 10px 20px;
    ...
    .corinthian-button:before {
      ...
      width: 100%;
      height: 100%;
      background: #fff url('https://res.cloudinary.com/dtf8hxbjn/image/upload/v1703798885/rss-feed/333df395-641d-4cb2-9c6e-a32f2ce39ce9_n2lo9p.jpg') repeat-x center;
...
<body>
  ...
  <a href="/src/files/rss-feed.opml" download="rss-feed.opml" class="corinthian-button">
    Download My RSS Feed
  </a>

</body>
</html>

I've used Reeder 5 as my app of choice and have loved it dearly.

I'm looking forward to the cahnge of pace from knowledge consumtpion to knowledge creation in 2024 and beyond!
