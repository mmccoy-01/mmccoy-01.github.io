...
<a class="download-button" href="#" onclick="downloadFile()">Download here</a>

<script>
function downloadFile() {
    var link = document.createElement('a');
    link.href = 'https://raw.githubusercontent.com/mmccoy-01/mmccoy-01.github.io/master/src/files/rss-feed.opml';
    link.download = 'rss-feed.opml';
...
I've used Reeder 5 as my app of choice and have loved it dearly. Although, you should be able import the .opml file into any RSS feed reader.
