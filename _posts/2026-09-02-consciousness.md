...
description: A personal, progressively layered account of consciousness as experience, embodiment, prediction, memory, biological organization, and an unfinished philosophical problem.
...
And consciousness is not behavior. Behavior is evidence, sometimes the only evidence available, but it is not the thing itself. In a [large 2024 study](https://doi.org/10.1056/NEJMoa2400645), about one quarter of behaviorally unresponsive patients showed task-related activity on EEG or fMRI. The finding is called **cognitive motor dissociation**. It makes the distinction brutally practical: inability to act is not proof of inability to experience.
...
This is [Aristotle’s illusion](https://pubmed.ncbi.nlm.nih.gov/23404333/). The stimulus has not doubled. The nervous system is interpreting an unfamiliar arrangement through the statistics of familiar touch. Two skin surfaces that do not normally meet one object at the same time are treated as evidence for two objects.
...
Consider thirst. In [experiments by Henk Aarts and colleagues](https://doi.org/10.1348/000712601162383), participants made thirsty by salty candy became quicker to recognize drink-related words and later recalled more drink-related objects. Their need had quietly reorganized attention. A glass of water did not become objectively brighter; it became cognitively louder.
...
![A diagram connecting perceived causality, need support, motivation, behavior regulation, and locus of control.](https://res.cloudinary.com/dtf8hxbjn/image/upload/v1788374026/Consciousness/09_op1djd.jpg)
...
Researchers distinguish **experienced duration** from **remembered duration**. While time is passing, attention matters. Looking backward, memory matters. The mind does not preserve a seamless recording; it segments life into events. Changes in place, goal, activity, or expectation create **event boundaries**, which help organize attention and long-term memory. [Work on event cognition](https://pmc.ncbi.nlm.nih.gov/articles/PMC5734104/) gives a more precise form to my original hunch.
...
![The Bayesian learning cycle: prior knowledge leads to prediction, data, prediction error, and a knowledge update.](https://res.cloudinary.com/dtf8hxbjn/image/upload/v1788374026/Consciousness/08_nq28mo.jpg)
...
- thirst raises the accessibility of goal-relevant cues;
- an illusion exposes a prior assumption;
- novelty draws a boundary around an event;
- learning updates expectations after error;
- habit allows expected detail to recede;
- attention determines which errors win access to limited processing.
...
![The classic forgetting curve: retention declines rapidly and then levels over time.](https://res.cloudinary.com/dtf8hxbjn/image/upload/v1788374025/Consciousness/05_l0354w.jpg)

![A schematic of spaced retrieval interrupting forgetting, with increasingly long gaps between recalls.](https://res.cloudinary.com/dtf8hxbjn/image/upload/v1788374025/Consciousness/06_qpfaxi.jpg)
...
![Kelley’s cube model of attribution, arranging consistency, consensus, and distinctiveness across situations and people.](https://res.cloudinary.com/dtf8hxbjn/image/upload/v1788374026/Consciousness/11_uuzhyl.jpg)
...
![The xkcd “Purity” comic, arranging academic fields according to how each discipline reduces the one before it.](https://res.cloudinary.com/dtf8hxbjn/image/upload/v1788374029/Consciousness/13_tf4eji.jpg)

*“Purity,” [xkcd #435](https://xkcd.com/435/) by Randall Munroe.*
...
![A simple comparative diagram labeling the cerebral hemispheres, cerebellum, forebrain, midbrain, and hindbrain.](https://res.cloudinary.com/dtf8hxbjn/image/upload/v1788374029/Consciousness/01_zxtvyp.jpg)
...
The **Perturbational Complexity Index** (PCI) turns part of that intuition into a measurement. Researchers perturb cortex with transcranial magnetic stimulation and record the response with EEG. A local or stereotyped response has lower complexity; a differentiated, widely interacting response has higher complexity. In the [original validation study](https://doi.org/10.1126/scitranslmed.3006294), PCI separated the sampled conscious and unconscious conditions with a cutoff near 0.31.
...
- **externally driven activity**, organized around current sensory events;
- **spontaneous activity**, arising from the system’s ongoing internal dynamics.
...
![A spectrum of the feeling of knowing, from familiarity and intuition to unfamiliarity and unreality, with a separate path toward cosmic or spiritual certainty.](https://res.cloudinary.com/dtf8hxbjn/image/upload/v1788374028/Consciousness/12_hjkq4i.jpg)
...
- Aarts, H., Dijksterhuis, A., & de Vries, P. (2001). [On the psychology of drinking: Being thirsty and perceptually ready](https://doi.org/10.1348/000712601162383).
- Block, R. A., & Zakay, D. (1997). [Prospective and retrospective duration judgments: A meta-analytic review](https://doi.org/10.3758/BF03209393).
- Bodien, Y. G., et al. (2024). [Cognitive motor dissociation in disorders of consciousness](https://doi.org/10.1056/NEJMoa2400645).
...
- Cogitate Consortium, et al. (2025). [Adversarial testing of global neuronal workspace and integrated information theories of consciousness](https://doi.org/10.1038/s41586-025-08888-1).
- Crapse, T. B., & Sommer, M. A. (2008). [Corollary discharge circuits in the primate brain](https://pmc.ncbi.nlm.nih.gov/articles/PMC2702467/).
- Jackson, F. (1982). Epiphenomenal qualia. *The Philosophical Quarterly, 32*(127), 127–136.
- Michael, M. T. (2020). [Unconscious emotion and free-energy: A philosophical and neuroscientific exploration](https://doi.org/10.3389/fpsyg.2020.00984).
- Quian Quiroga, R., et al. (2005). [Invariant visual representation by single neurons in the human brain](https://doi.org/10.1038/nature03687).
- Radvansky, G. A., & Zacks, J. M. (2017). [Event boundaries in memory and cognition](https://pmc.ncbi.nlm.nih.gov/articles/PMC5734104/).
...
- Seth, A. K., & Friston, K. J. (2016). [Active interoceptive inference and the emotional brain](https://pmc.ncbi.nlm.nih.gov/articles/PMC5062097/).
- Tinazzi, M., et al. (2013). [Aristotle’s illusion reveals interdigit functional somatosensory alterations in focal hand dystonia](https://pubmed.ncbi.nlm.nih.gov/23404333/).
